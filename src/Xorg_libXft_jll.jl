...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXft_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2c808117-e144-5220-80d1-69d4eaa9352c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libXft", artifacts_toml) for e in artifacts["Xorg_libXft"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXft; unsupported platform $(triplet(platform_key_abi()))")
else
